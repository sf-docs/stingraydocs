...
Рекомендациями в данном случае является включение ATS в полном объеме на уровне всего приложения и без исключений для доменов. рекомендуемая конфигурация:
