...
Приложение использует хранилище ключей со слабым паролем, содержащее закрытые ключи. Keystore и хранящиеся в нём ключи должны быть защищены надёжным паролем.
