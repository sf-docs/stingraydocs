...
* **Изменен** — время запуска сканирования.
...
Дополнительная вкладка **Лог** доступна только во время выполнения тест-кейса при запуске сканирования, при работе с устройством и при анализе. Она предоставляет возможность просмотра лога сканирования.
