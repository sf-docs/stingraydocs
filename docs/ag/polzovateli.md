...
Назначение проектных ролей пользователей осуществляется на вкладке **Проекты** страницы **Настройки**. Более подробную информацию см. в разделе «[Добавление пользователя](/ag/polzovateli/#_6)».
...
* **Аватар** пользователя.
* **Пароль** пользователя (см. раздел «[Смена пароля пользователя](/ag/polzovateli/#_9)».
