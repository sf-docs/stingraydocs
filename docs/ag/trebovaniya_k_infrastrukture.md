...
-|:-:|:-:|:-:
2 Android, 2 iOS|6*|12|24
4 Android, 4 iOS|8*|16|24
6 Android, 6 iOS|12*|24|32

\* При виртуализации количество vCPU должно соответствовать общему количеству потоков.
